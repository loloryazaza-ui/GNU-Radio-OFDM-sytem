...
class simple_OFDM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "simple_OFDM")
        ...
        self._noise_voltage_range = qtgui.Range(0, 2, 0.1, 0, 200)
        ...
        self.fec_ber_bf_0 = fec.ber_bf(True, 10000, -7.0)
        ...
        self.digital_ofdm_rx_0 = digital.ofdm_rx(
            ...
            frame_length_tag_key='frame_'+'None',
            packet_length_tag_key='None',
            occupied_carriers=((-4, -3, -2, -1, 1, 2, 3, 4),),
            pilot_carriers=((-6, -5, 5, 6),),
            pilot_symbols=((-1, 1, -1, 1),),
            sync_word1=None,
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, './TX2.txt', False)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_file_source_0, 0), (self.blocks_file_sink_1, 0))
...
def main(top_block_cls=simple_OFDM, options=None):
